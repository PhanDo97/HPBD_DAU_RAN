const contentLetterSrart_actived = "Chào người yêu thương của anh. Mỗi ngày bên em là một ngày đáng trân trọng đối với anh. Em đã đến làm thay đổi cuộc sống anh, cho anh nhiều động lực hơn để cố gắng..." //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc mừng sinh nhật người yêu của anh!!! Hãy để những niềm vui, nụ cười và thành công đồng hành cùng em trên hành trình đẹp đẽ này em nhé. Anh sẽ luôn ở đây, sẵn sàng chia sẻ những niềm vui và chia sẻ gánh nặng cùng em. YÊU EM!!!" //Nội dung của bức thư
...
document.querySelector(".startForm").addEventListener("click", function () { //Hiệu ứng gõ chữ cho phần mở đầu của bức thư
...
function createLight(a) {
    ...
    for (var i = 0; i < count; i++) {
        ...
        var color = "white";
        var blur = Math.floor(Math.random());
        var widthEle = Math.floor(Math.random() * 9) + 15;
